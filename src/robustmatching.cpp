...
{
	// Read input images
	cv::Mat image1= cv::imread("/home/bobo/code/Mul_view_example/data/canal1.jpg",0);//=0,return gray image
	cv::Mat image2= cv::imread("/home/bobo/code/Mul_view_example/data/canal2.jpg",0);
	...
	// Draw the epipolar lines,image1中点points1的极线在image2上
